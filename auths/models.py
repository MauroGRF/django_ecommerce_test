...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, nombre, apellido, username, email, password=None, **extra_fields):
        ...
        extra_fields.setdefault("is_superadmin", True) #esta creo que no va, si no superuser
...
class UserAuth(AbstractBaseUser, PermissionsMixin):  # Agrega PermissionsMixin
